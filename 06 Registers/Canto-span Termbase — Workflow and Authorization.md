---
title: "Canto-span Vocabulary Stress-Test Fixture v0.1 — Workflow and Authorization"
...
- **Canonical owner:** `data/construction-candidate-readiness.json and deterministic reports`
- **Frozen reference:** `Vazhi/canto-span@c9dd631739734a5ab886f0b667db9888b0add13b:data/construction-candidate-readiness.json | Vazhi/canto-span@c9dd631739734a5ab886f0b667db9888b0add13b:validation/current/supported-productive-discovery.json`
- **Change status:** `new_project_term`
