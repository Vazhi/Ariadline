---
title: "Canto-span Vocabulary Stress-Test Fixture v0.1 — Status and Evidence"
...
# Canto-span Vocabulary Stress-Test Fixture v0.1 — Status and Evidence
...
- **Canonical owner:** `docs/current/GOVERNANCE.md and docs/current/DEFINITION-OF-DONE.md`
- **Frozen reference:** `Vazhi/canto-span@c9dd631739734a5ab886f0b667db9888b0add13b:docs/current/GOVERNANCE.md | Vazhi/canto-span@c9dd631739734a5ab886f0b667db9888b0add13b:docs/current/DEFINITION-OF-DONE.md`
- **Change status:** `status_literal`

## CS-TERM-0013 — research_pending

- **Concept ID:** `CS-CONCEPT-RESEARCH-PENDING`
- **Definition:** the status for a concrete linguistic question whose provisional requirements remain incomplete
- **Scope:** Canto-span linguistic status vocabulary
- **Allowed variants:** research pending
- **Excluded interpretations:** actively assigned work; unsupported in every respect; inactive; unavailable
- **Example:** AA01 remains research_pending while source, panel, or boundary requirements are incomplete.
- **Canonical owner:** `one current note under grammar/<status>/`
- **Frozen reference:** `Vazhi/canto-span@c9dd631739734a5ab886f0b667db9888b0add13b:docs/current/GOVERNANCE.md`
- **Change status:** `status_literal`
...
## CS-TERM-0047 — provisional_reaudit

- **Concept ID:** `CS-CONCEPT-PROVISIONAL-REAUDIT`
- **Definition:** the status for an earlier acceptance that has been withdrawn pending review under the current standard
- **Scope:** Canto-span linguistic status vocabulary
- **Allowed variants:** provisional reaudit
- **Excluded interpretations:** current acceptance; active assignment; retirement
- **Example:** A record in provisional_reaudit requires current-standard review before renewed acceptance.
- **Canonical owner:** `one current note under grammar/<status>/`
- **Frozen reference:** `Vazhi/canto-span@c9dd631739734a5ab886f0b667db9888b0add13b:docs/current/GOVERNANCE.md`
- **Change status:** `status_literal`

## CS-TERM-0048 — provisional

- **Concept ID:** `CS-CONCEPT-PROVISIONAL`
- **Definition:** the status for a bounded claim that satisfies only the declared provisional requirements
- **Scope:** Canto-span linguistic status vocabulary
- **Allowed variants:** provisional status
- **Excluded interpretations:** supported_productive; research assignment; runtime recognition
- **Example:** A provisional record has not passed every supported_productive gate.
- **Canonical owner:** `one current note under grammar/<status>/`
- **Frozen reference:** `Vazhi/canto-span@c9dd631739734a5ab886f0b667db9888b0add13b:docs/current/GOVERNANCE.md`
- **Change status:** `status_literal`
