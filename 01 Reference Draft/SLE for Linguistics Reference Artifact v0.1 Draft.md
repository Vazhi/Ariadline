---
title: "SLE for Linguistics Reference Artifact v0.1 Draft"
...
This is the assembled **proposed** SLE for Linguistics reference artifact. It is a human-readable publication draft, not a stable standard.
...
SLE controls communication form. SLE conformance does not establish linguistic truth, grammaticality, theoretical correctness, methodological validity, ethical adequacy, translation quality, accessibility, software correctness, or community authority.
...
1. [[SLE for Linguistics Language Rules v0.1]] controls normative rule wording.
2. [[SLE for Linguistics Document Patterns v0.1]] controls proposed document-pattern obligations and boundaries.
...
Simplified Linguistic English is a proposed controlled form of English for linguistic description, evidence reporting, research documentation, editorial review, and related technical communication.
...
The controlling 24-rule chapter is [[SLE for Linguistics Language Rules v0.1]]. The compact publication index is [[SLE Rule and Pattern Index v0.1]].
...
SLE does not certify example acceptability, translation quality, segmentation, gloss analysis, citation correctness, or scientific sufficiency. Those require separately scoped authority.
...
The controlling pattern chapter is [[SLE for Linguistics Document Patterns v0.1]].
...
Reusable outlines and examples are in [[SLE Document Pattern Outlines v0.1]] and [[SLE Document Pattern Example Bank v0.1]].
...
A profile declaration is auditable only when it identifies the profile-set version and resolves conditional applicability. [[SLE Profile Applicability Register v0.1]] controls the exact mappings.

## 8. Editorial conformance

[[SLE Editorial Conformance Checklist v0.1]] provides one human-review question for each rule.
...
An extension must identify the controlling SLE and profile-set versions, distinguish local requirements, list affected rule IDs, and state compatibility.
...
An editor may determine whether declared content is communicated under applicable SLE controls. The editor must not use the SLE result to certify truth, grammaticality, theory, method, ethics, translation, accessibility, software, or community authorization.

When a proposed edit could change authorized meaning, use [[SLE Semantic Equivalence Review Template v0.1]]. If legitimate meaning authority is unavailable, record **not determined**.

## 11. Examples and internal audit material

[[SLE Rule Test Case Catalog v0.1]] contains constructed pass, fail, provisional borderline, and typed boundary prompts.

[[Multi-Domain SLE Evaluation Corpus v0.1]] is a constructed internal audit corpus. Its controlled alternatives match project-constructed briefs in internal review, but independent preservation remains **not determined**.
...
Independent source analysis is in [[Independent SLE Rule Evidence Register v0.1]].

Exact rule-to-rationale, checklist, case, and audit-prompt mappings are in [[SLE Rule Traceability Matrix v0.1]].
...
The current rejected and deferred proposals are recorded in [[SLE Reference Change and Deferral Log v0.1]].
...
The detailed status of every component is in [[SLE Reference Publication Map v0.1]].

## 16. Canto-span boundary

Canto-span is not a normative source, gold standard, profile, terminology authority, repository requirement, or conformance model for SLE.

[[Canto-span Evaluation Subset v0.1]], [[Canto-span Case Study]], and related fixtures are informative, non-authoritative stress tests only. A Canto-span finding can affect core SLE only through the ordinary independent-evidence and governance process.

## 17. Optional tooling and project documentation

Software is optional. [[Optional Automation Notes for SLE Review v0.1]] describes limited flagging and review assistance.
...
Project-management documentation is outside the core linguistic document patterns. It may be addressed through informative annexes or local extensions without becoming a universal SLE requirement.
